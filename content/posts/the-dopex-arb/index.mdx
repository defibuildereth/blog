...
If we can set up this situation, or something close to it, we'll either win the premium of the AS less the cost of our insurance (if the price goes up), or our insurance will pay off exactly enough to cover ouw downside (if the price goes down).
...
Then all we'll need is for dat glorious volatility to return to the markets and we'd potentially have a nice little profit machine set up.
